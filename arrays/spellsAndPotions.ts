 ...
 * link: https://leetcode.com/problems/successful-pairs-of-spells-and-potions/?envType=study-plan-v2&envId=leetcode-75
**/ 
...
//nlogn
function successfulPairsOptimized(spells: number[], potions: number[], success: number): number[] {
